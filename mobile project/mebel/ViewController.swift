...
class ViewController: UIViewController, UISearchBarDelegate{
    ...
    func makeIcons(){
        ...
        iconBasket.image = iconBasket.image?.withRenderingMode(.alwaysTemplate).withAlignmentRectInsets(Paddings.minus10)
        iconBasket.tintColor = Colors.hexStringToUIColor(hex: Colors.colorWhite)
